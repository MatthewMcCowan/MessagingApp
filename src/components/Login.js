    ...
    <div className="login">
      <div className="login__logo flex flex-col items-center h-screen bg-gray-200 place-content-center">
        <img
          src={sketchArt}
          alt="logo space"
          className="w-40 h-40 rounded-lg border-2 p-2 bg-blue-300 shadow-lg object-contain"
        />
        <h2 className='text-5xl font-bold text-gray-700 mb-40 uppercase'>Star Message</h2>
